...
import { getStudentTransportDetails } from '../../src/api/transportApi';
import { useAuth } from '../../src/context/AuthContext';
import { StudentTransportDetails } from '../../src/types/transport';
...
export default function TransportScreen() {
  ...
  const handleCallDriver = () => {
    if (transportData?.driver.contactNumber) {
      Linking.openURL(`tel:${transportData.driver.contactNumber}`);
    }
  };

  if (state.status === 'loading' || !user || (loading && !transportData)) {
  ...
  return (
    ...
    >
      <Text style={styles.pageTitle}>Transport Details</Text>
        ...
        <View style={[styles.column, isWeb && { flex: 1.5 }]}>
            ...
            <View style={styles.card}>
                <View style={styles.headerRow}>
                    ...
                    <View>
                        ...
                        <Text style={styles.subValue}>ID: {transportData.routeId}</Text>
                    </View>
                </View>
            </View>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.stopContainer}>
                    ...
                    <Text style={styles.stopName}>{transportData.myStop.stopName}</Text>
                </View>
                ...
                <View style={styles.timeRow}>
                    <View style={styles.timeBox}>
                        ...
                        <View style={styles.timeValueBox}>
                           ...
                           <Text style={styles.timeValue}>{transportData.myStop.pickupTime}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.timeBox}>
                        ...
                        <View style={styles.timeValueBox}>
                           ...
                           <Text style={styles.timeValue}>{transportData.myStop.dropTime}</Text>
                        </View>
                    </View>
                </View>
            </View>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.vehicleRow}>
                    ...
                    <View style={{marginLeft: 16}}>
                        <Text style={styles.busNumber}>{transportData.vehicle.busNumber}</Text>
                        <Text style={styles.plateNumber}>{transportData.vehicle.vehicleNumber}</Text>
                    </View>
                </View>
                ...
                <View style={styles.driverRow}>
                    ...
                    <View style={{flex: 1, marginLeft: 12}}>
                        <Text style={styles.driverName}>{transportData.driver.name}</Text>
                        <Text style={styles.driverId}>ID: {transportData.driver.id}</Text>
                    </View>
...
const styles = StyleSheet.create({
  ...
  subValue: { fontSize: 13, color: '#9CA3AF', marginTop: 2 },
  ...
  driverAvatar: {
      width: 44, height: 44, borderRadius: 22, backgroundColor: '#4B5563',
