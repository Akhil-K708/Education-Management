...
const styles = StyleSheet.create({
  ...
  cardContainer: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 20, marginBottom: 5, width: '100%', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 12, elevation: 3, borderWidth: 1, borderColor: '#F3F4F6' },
  teacherRow: { flexDirection: 'row', alignItems: 'center' },
  teacherAvatar: { width: 50, height: 50, borderRadius: 25, backgroundColor: '#F97316', alignItems: 'center', justifyContent: 'center', marginRight: 16, shadowColor: '#F97316', shadowOffset: {width:0, height:2}, shadowOpacity: 0.3, shadowRadius: 4, elevation: 4 },
  teacherLabel: { fontSize: 12, color: '#6B7280', marginBottom: 2, textTransform: 'uppercase', letterSpacing: 0.5, fontWeight: '600' },
  teacherValue: { fontSize: 16, color: '#111827', fontWeight: 'bold' },
  sectionHeader: { fontSize: 18, fontWeight: 'bold', color: '#111827', marginBottom: 12, marginTop: 16 },
  subjectsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 24 },
  subjectPill: { paddingVertical: 8, paddingHorizontal: 20, borderRadius: 20, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E5E7EB' },
  subjectPillActive: { backgroundColor: '#F97316', borderColor: '#F97316', shadowColor: '#F97316', shadowOffset: {width:0, height:2}, shadowOpacity: 0.3, shadowRadius: 4, elevation: 3 },
  subjectText: { fontSize: 14, color: '#4B5563', fontWeight: '600' },
  ...
  subHeader: { fontSize: 16, fontWeight: '600', color: '#374151', marginBottom: 12 },
  ...
  dayBadge: { backgroundColor: '#FFF7ED', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6 },
  dayText: { fontSize: 13, fontWeight: 'bold', color: '#C2410C', textTransform: 'capitalize' },
  subjectTextList: { fontSize: 15, fontWeight: 'bold', color: '#111827', textTransform: 'capitalize' },
  colCenter: { flex: 1.5, alignItems: 'center' },
  timeBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9FAFB', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6 },
